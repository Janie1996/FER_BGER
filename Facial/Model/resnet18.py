...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers,batch,C,K, num_classes=7, zero_init_residual=False,
    ...
    def forward(self, x):
        ...
        out,features1 = self.rnn1(clips)
        del clips

        return probs, end, out, end + probs + out#,features1,features
...
if __name__ == '__main__':#【clip_length，batch，frame_length，channel
    a=torch.ones([5,2,3,3,224,224]).cuda()
    model=resnet18(5,3,5,7).cuda()
    model(a)
